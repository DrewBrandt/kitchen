param(
  ...
  [Parameter(Mandatory)]
  [ValidateSet('/v1/inventory', '/v1/history', '/v1/history/reconcile', '/v1/plans', '/v1/grocery-items', '/v1/foods', '/v1/groceries', '/v1/recipes', '/v1/external-foods', '/v1/meals', '/v1/targets', '/v1/access')]
  [string]$Path,
